...
def compose_email(messages: list, role: str, kpis: dict,
    ...
    avg_prod_rating = kpis.get("avg_product_rating", 0)
    top_channel     = kpis.get("top_channel", "N/A")

    # ── KPI rows ───────────────────────────────────────────────────────────────
    kpi_rows = f"""
      <tr>
        <td style="padding:8px 14px;color:#64748b;font-size:14px">Total Revenue</td>
        <td style="padding:8px 14px;text-align:right;font-weight:600;color:#2563eb;font-size:14px">${total_revenue:,.0f}</td>
      </tr>
      <tr style="background:#f8fafc">
        <td style="padding:8px 14px;color:#64748b;font-size:14px">Total Orders</td>
        <td style="padding:8px 14px;text-align:right;font-weight:600;color:#16a34a;font-size:14px">{total_orders:,}</td>
      </tr>
      <tr>
        <td style="padding:8px 14px;color:#64748b;font-size:14px">Completion Rate</td>
        <td style="padding:8px 14px;text-align:right;font-weight:600;color:#d97706;font-size:14px">{completion_rate:.1f}%</td>
      </tr>
      <tr style="background:#f8fafc">
        <td style="padding:8px 14px;color:#64748b;font-size:14px">Avg Product Rating</td>
        <td style="padding:8px 14px;text-align:right;font-weight:600;color:#2563eb;font-size:14px">{avg_prod_rating:.2f} / 5.0</td>
      </tr>
      <tr>
        <td style="padding:8px 14px;color:#64748b;font-size:14px">Top Channel</td>
        <td style="padding:8px 14px;text-align:right;font-weight:600;color:#7c3aed;font-size:14px">{top_channel}</td>
      </tr>
    """
    ...
    subject = f"Business AI Copilot — {role} E-Commerce Analysis — {date_str}"
        ...
        <tr>
          <td style="background:#f8fafc;border-top:1px solid #e2e8f0;
            ...
            <p style="margin:0;font-size:12px;color:#94a3b8;line-height:1.6">
              ...
              E-Commerce Dataset &nbsp;·&nbsp; This is an automated summary.
            </p>
          </td>
        </tr>
